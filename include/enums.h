...
enum MenuID {
    ...
    MENU_STATUS = 0x3,
    MENU_SKILLS = 0x4,
    MENU_MEMO_SELECT = 0x5,
    MENU_MEMO_VIEW = 0x6,
    MENU_BATTLE_MEMORY = 0x7,
    MENU_SHOP_TRANSACTION_SELECT = 0x8,
    MENU_SHOP_CHARACTER_SELECT = 0x9,
    MENU_SHOP_ITEM_SELECT_BUY = 0xA,
    MENU_SHOP_ITEM_SELECT_SELL = 0xB,
    MENU_ITEM_GUY_TRANSACTION_SELECT = 0xC,
    MENU_ITEM_GUY_CHARACTER_SELECT = 0xD,
    MENU_ITEM_GUY_ITEM_SELECT_DEPOSIT = 0xE,
    MENU_ITEM_GUY_ITEM_SELECT_WITHDRAW = 0xF,
    MENU_SAVE_SELECT = 0x10,
    MENU_NEW_GAME = 0x11,
    MENU_TRY_AGAIN = 0x12
};
