...
enum PartyCharacterID {
    PARTY_MEMBER_EMPTY_0 = 0,
    PARTY_MEMBER_FLINT = 1,
    PARTY_MEMBER_LUCAS = 2,
    PARTY_MEMBER_DUSTER = 3,
    PARTY_MEMBER_KUMATORA = 4,
    PARTY_MEMBER_BONEY = 5,
    PARTY_MEMBER_SALSA = 6,
    PARTY_MEMBER_WESS = 7,
    PARTY_MEMBER_THOMAS = 8,
    PARTY_MEMBER_IONIA = 9,
    PARTY_MEMBER_FUEL = 10,
    PARTY_MEMBER_ALEC = 11,
    PARTY_MEMBER_FASSAD = 12,
    PARTY_MEMBER_CLAUS = 13,
    PARTY_MEMBER_EMPTY_1 = 14,
